...
// we did not.
const RECIPES = {
  grass:    [['grass', 0.7, 0.7, 1.35], ['shrub', 0.09, 0.7, 1.4], ['tree0', 0.025, 0.5, 1.9], ['tree2', 0.025, 0.5, 1.8], ['pod', 0.02, 0.8, 1.4], ['rock', 0.12, 0.10, 1.5]],
  forest:   [['tree0', 0.22, 0.5, 2.3], ['tree1', 0.16, 0.45, 2.0], ['tree2', 0.12, 0.5, 2.1], ['shrub', 0.12, 0.8, 1.5], ['grass', 0.30, 0.7, 1.35], ['rock', 0.08, 0.10, 1.8]],
  ...
  slime:    [['pod', 0.14, 1.0, 2.0], ['tree1', 0.03, 0.6, 2.2], ['tree2', 0.02, 0.6, 2.1], ['blob', 0.14, 0.6, 2.0], ['grass', 0.2, 0.8, 1.45], ['crystal', 0.03, 0.5, 1.4]],
  ...
  dryland:  [['grass', 0.28, 0.6, 1.2], ['shrub', 0.055, 0.6, 1.2], ['rock', 0.20, 0.09, 1.9]],
};
